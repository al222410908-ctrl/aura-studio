    ...
    <section id="inicio" className="relative overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-24">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 lg:px-8">
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="max-w-3xl">
          ...
          <motion.p variants={fadeInUp} className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
          ...
          <motion.div variants={fadeInUp} className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
